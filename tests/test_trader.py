...
mock_quotexpy_module = MagicMock()
mock_qx_instance = AsyncMock()
mock_quotexpy_module.Quotex.return_value = mock_qx_instance
sys.modules['quotexpy'] = mock_quotexpy_module

# Mock Fernet for email/password decryption
...
async def test_execute_trade_returns_trade_object(sample_user):
    ...
    mock_quotexpy_module.Quotex.return_value = mock_qx
